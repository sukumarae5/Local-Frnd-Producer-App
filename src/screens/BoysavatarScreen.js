...
import { View, Text, StyleSheet, TouchableOpacity, Image, FlatList, StatusBar, SafeAreaView } from "react-native";
import LinearGradient from "react-native-linear-gradient";

const AVATARS = [
  { id: 1, image: require("../assets/boy1.jpg") },
  { id: 2, image: require("../assets/boy2.jpg") },
  { id: 3, image: require("../assets/boy3.jpg") },
  { id: 4, image: require("../assets/boy4.jpg") },
  { id: 5, image: require("../assets/boy5.jpg") },
...
const BoysavatarScreen = ({ navigation }) => {
  ...
  return (
    <LinearGradient colors={["#000000", "#1a001f", "#2d0033"]} style={styles.container}>
